...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "site_logo": "vendor/adminlte/img/logo.jpg",
...
def get_settings() -> Dict:
    ...
    if jazzmin_settings["search_model"]:
        if not isinstance(jazzmin_settings["search_model"], list):
            jazzmin_settings["search_model"] = [
                jazzmin_settings["search_model"]]

        jazzmin_settings["search_models_parsed"] = []
        for search_model in jazzmin_settings["search_model"]:
            jazzmin_search_model = {}
            jazzmin_search_model["search_url"] = get_admin_url(
                get_search_model_string(search_model))
            ...
            if model_meta:
                ...
                jazzmin_search_model["search_name"] = search_model.split(
                    ".")[-1] + "s"
            jazzmin_settings["search_models_parsed"].append(
                jazzmin_search_model)
...
def get_ui_tweaks() -> Dict:
    ...
    if dark_mode_theme:
        ret["dark_mode_theme"] = {
            "name": dark_mode_theme, "src": static(THEMES[dark_mode_theme])}

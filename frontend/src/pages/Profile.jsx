...
function Profile() {
  ...
  return (
    <div className="flex flex-col items-center justify-start bg-gradient-to-r from-yellow-100 via-yellow-300 to-yellow-500 h-screen py-12">
      <h1 className="text-3xl font-semibold text-gray-700">
        Update Your Profile
      </h1>
      <form className="flex flex-col gap-5 w-1/2" onSubmit={submitHandler}>
        <input
